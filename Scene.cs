...
public class Scene
{
    ...
    public Scene()
    {
        ...
        // Area light
        Primitives.Add(new Sphere(new Vector3(0f, 12f, 0f), 5f, Vector3.Zero,
        ...
        Primitives.Add(new Triangle(new Vector3(-2f, 1f, 9f), new Vector3(2f, 1, 9f), 
            new Vector3(0f, 4f, 9f), new Vector3(1, 0, 0), 0.5f));
